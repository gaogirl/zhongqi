 ...
 * 或通过 HTTP 请求: POST /api/init-sample-data（仅开发环境）
 */
...
const sampleTerms = [
  ...
  { term: '生态系统', meaning: 'Ecosystem - 生物群落与其物理环境相互作用形成的复杂系统。', cat: '环境科学' },
...
async function initSampleData() {
  try {
    ...
    console.log('\n示例数据初始化完成！');
    console.log('你现在可以在前端术语库和案例库页面看到示例数据了。');
